...
function initContributionModal() {
    ...
    if (closeSchneiderBtn) {
        closeSchneiderBtn.addEventListener("click", window.closeContributionModal);
    }
    if (closeSchneiderBtnBottom) {
        closeSchneiderBtnBottom.addEventListener("click", window.closeContributionModal);
    }
    if (schneiderModal) {
        schneiderModal.addEventListener("click", (e) => {
            if (e.target === schneiderModal) {
                window.closeContributionModal();
            }
        });
    }
    ...
    if (closeCleanoraBtn) {
        closeCleanoraBtn.addEventListener("click", window.closeContributionModal);
    }
    if (closeCleanoraBtnBottom) {
        closeCleanoraBtnBottom.addEventListener("click", window.closeContributionModal);
    }
    if (cleanoraModal) {
        cleanoraModal.addEventListener("click", (e) => {
            if (e.target === cleanoraModal) {
                window.closeContributionModal();
            }
        });
    }

    if (closeSmartHomeBtn) {
        closeSmartHomeBtn.addEventListener("click", window.closeContributionModal);
    }
    if (closeSmartHomeBtnBottom) {
        closeSmartHomeBtnBottom.addEventListener("click", window.closeContributionModal);
    }
    if (smartHomeModal) {
    ...
    if (closeNavriseBtn) {
        closeNavriseBtn.addEventListener("click", window.closeContributionModal);
    }
    if (closeNavriseBtnBottom) {
        closeNavriseBtnBottom.addEventListener("click", window.closeContributionModal);
    }
    if (navriseModal) {
        navriseModal.addEventListener("click", (e) => {
            if (e.target === navriseModal) {
                window.closeContributionModal();
            }
        });
    }
